                            ...
                            <Table.Body items={visibleEquipments}>
                                {(item) => (
                                    <Table.Row id={item.id}>
                                        ...
                                        {/* Expiration stays at 12px even on wide screens (overrides the
                                            2xl:text-sm bump the other cells get from cellStyles). */}
                                        <Table.Cell className={cx(cellStyles, "whitespace-nowrap text-xs 2xl:text-xs")}>
                                            {item.expirationDate ? (
